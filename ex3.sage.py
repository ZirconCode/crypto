...
_sage_const_607 = Integer(607); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_100 = Integer(100); _sage_const_14 = Integer(14); _sage_const_150 = Integer(150); _sage_const_75 = Integer(75); _sage_const_352787 = Integer(352787)
import random
...
def onetrial(n):
	...
	for j in range(s):
		x = Integer(x).powermod(x**_sage_const_2 , n)
...
print mrtest( _sage_const_352787 , _sage_const_100 )
# -> True
